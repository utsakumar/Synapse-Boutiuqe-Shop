...
public class tie extends JFrame implements MouseListener
{
	JLabel logo,donatepic,customercarepic,searchbar,line2,languagepic, title,subtitle,line1,tiel,gownl,blacktieL,ballgownl,sheathl,fitandflarel,alinel, name, name1;
	JPanel panel;
	...
	ButtonGroup bg1;
	//ImageIcon img;
	JButton back,donate,languages,customercare,tie,gown,blacktie,ballgown,sheath,fitandflare,aline,facebook,insta,twiter,image1,purchasep,p11,p22,p33;
	Border b1=BorderFactory.createLineBorder(new Color(120,120,120),3,true);
	JTextField searchT;
	JFrame frame;
	
	private String product_tie="Handwoven Raw Silk Blend Tie";
	...
	public tie()
	{
		...
		donate.setBounds(395,20,150,25);
		...
		title = new JLabel("T I E");
		title.setBounds(130,10,180,40);
		...
		image1 =new JButton(new ImageIcon("image/tie1.png"));
		image1.setBounds(25,115,385,400);
		...
		JLabel details1=new JLabel("Brand: OKHAI");
		details1.setBounds(140,530,300,25);
		...
		name=new JLabel("Handwoven Raw Silk Blend Tie");
		...
		name1=new JLabel("Casual, Formal, Festive & Wedding tie");
		...
		rating.setBounds(680,180,128,128);
		frame.add(rating);
		
		JLabel extra1=new JLabel("4.2(56)");
		extra1.setBounds(820,230,120,30);
		...
		p11=new JButton(new ImageIcon("image/tie11.png"));
		...
		p11.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p11)
				{
					image1.setIcon(new ImageIcon("image/tie1.png"));
					image1.setBounds(25,115,385,400);
				}
		...
		p22=new JButton(new ImageIcon("image/tie22.png"));
		...
		p22.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p22)
				{
					image1.setIcon(new ImageIcon("image/tie2.png"));
					image1.setBounds(25,115,385,400);
				}
		...
		p33=new JButton(new ImageIcon("image/tie33.png"));
		...
		p33.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p33)
				{
					image1.setIcon(new ImageIcon("image/tie3.png"));
					image1.setBounds(30,115,385,400);
				}
		...
		JButton blazerb = new JButton(new ImageIcon("image/blazer.png"));
		blazerb.setBounds(935, 165, 200, 205);
		blazerb.setBackground(c1);
		blazerb.setCursor(new Cursor(Cursor.HAND_CURSOR));
		blazerb.setBorder(null);
		frame.add(blazerb);

		JLabel blazerbl = new JLabel("B L A Z E R");
		blazerbl.setBounds(970, 365, 150, 30);
		blazerbl.setForeground(new Color(60, 80, 110));
		blazerbl.setFont(new Font("Garamond", Font.PLAIN, 20));
		blazerbl.setOpaque(false);
		frame.add(blazerbl);

		JButton vest = new JButton(new ImageIcon("image/vest.png"));
		vest.setBounds(935, 390, 190, 200);
		...
		vestl.setBounds(1000, 585, 150, 30);
		...
		purchasep.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					purchasep q=new purchasep(product_tie, proPrice , quantity1);
					frame.setVisible(false);
					q.setVisible(true);
				}
			}
