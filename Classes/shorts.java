...
public class shorts extends JFrame implements MouseListener
{
	JLabel logo,donatepic,customercarepic,searchbar,line2,languagepic, title,subtitle,line1,shortsl,gownl,blackshortsL,ballgownl,sheathl,fitandflarel,alinel, name, name1;
	JPanel panel;
	...
	ButtonGroup bg1;
	//ImageIcon img;
	JButton back,donate,languages,customercare,shorts,gown,blackshorts,ballgown,sheath,fitandflare,aline,facebook,insta,twiter,image1,purchasep,p11,p22,p33;
	Border b1=BorderFactory.createLineBorder(new Color(120,120,120),3,true);
	JTextField searchT;
	JFrame frame;
	
	private String product_shorts="AE Flex Lived-In Cargo Short";
	...
	public shorts()
	{
		...
		title = new JLabel("CURGO SHORTS");
		title.setBounds(32,10,400,50);
		...
		image1 =new JButton(new ImageIcon("image/shorts1.png"));
		...
		JLabel details1=new JLabel("Brand: WRANGLER");
		details1.setBounds(120,530,300,25);
		...
		name=new JLabel("AE Flex Lived-In Cargo Short");
		...
		name1=new JLabel("12 inch Longer Length Men shorts");
		...
		JLabel extra1=new JLabel("3.9(267)");
		...
		p11=new JButton(new ImageIcon("image/shorts11.png"));
		...
		p11.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p11)
				{
					image1.setIcon(new ImageIcon("image/shorts1.png"));
					image1.setBounds(20,125,385,400);
				}
		...
		p22=new JButton(new ImageIcon("image/shorts22.png"));
		...
		p22.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p22)
				{
					image1.setIcon(new ImageIcon("image/shorts2.png"));
		...
		p33=new JButton(new ImageIcon("image/shorts33.png"));
		...
		p33.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p33)
				{
					image1.setIcon(new ImageIcon("image/shorts3.png"));
		...
		grafictee.setBounds(935, 390, 192, 200);
		...
		graficteel.setBounds(970, 585, 180, 30);
		...
		JButton jeans = new JButton(new ImageIcon("image/jeans.png"));
		jeans.setBounds(932, 170, 200, 197);
		...
		jeansL.setBounds(970, 365, 200, 30);
		...
		purchasep.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					purchasep q=new purchasep(product_shorts, proPrice , quantity1);
					frame.setVisible(false);
					q.setVisible(true);
				}
			}
