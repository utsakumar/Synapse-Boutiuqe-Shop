...
public class shirt extends JFrame implements MouseListener
{
	JLabel logo,donatepic,customercarepic,searchbar,line2,languagepic, title,subtitle,line1,shirtl,gownl,blackshirtL,ballgownl,sheathl,fitandflarel,alinel, name, name1;
	JPanel panel;
	...
	ButtonGroup bg1; 
	//ImageIcon img;
	JButton back,donate,languages,customercare,shirt,gown,blackshirt,ballgown,sheath,fitandflare,aline,facebook,insta,twiter,image1,purchasep,p11,p22,p33;
	Border b1=BorderFactory.createLineBorder(new Color(120,120,120),3,true);
	JTextField searchT;
	JFrame frame;
	
	private String product_shirt="Arrow Manhattan Slim Fit Shirt";
	private String proPrice="750";
	...
	public shirt()
	{
		...
		title = new JLabel("S H I R T");
		title.setBounds(90,10,280,40);
		...
		image1 =new JButton(new ImageIcon("image/shirt1.png"));
		...
		details1.setBounds(115,530,300,25);
		...
		name=new JLabel("Arrow Manhattan Slim Fit Shirt");
		...
		name1=new JLabel("Men Formal shirt");
		...
		JLabel extra1=new JLabel("4.2(100)");
		...
		p11=new JButton(new ImageIcon("image/shirt11.png"));
		...
		p11.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p11)
				{
					image1.setIcon(new ImageIcon("image/shirt1.png"));
					image1.setBounds(20,125,385,400);
				}
		...
		p22=new JButton(new ImageIcon("image/shirt22.png"));
		...
		p22.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p22)
				{
					image1.setIcon(new ImageIcon("image/shirt2.png"));
		...
		p33=new JButton(new ImageIcon("image/shirt33.png"));
		...
		p33.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p33)
				{
					image1.setIcon(new ImageIcon("image/shirt3.png"));
		...
		vest.setBounds(935, 170, 190, 200);
		...
		vestl.setBounds(1000, 365, 150, 30);
		...
		purchasep.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					purchasep q=new purchasep(product_shirt, proPrice , quantity1);
					frame.setVisible(false);
					q.setVisible(true);
				}
			}
