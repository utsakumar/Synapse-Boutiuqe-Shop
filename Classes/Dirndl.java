...
public class Dirndl extends JFrame implements MouseListener//, ActionListener
{
	...
	JButton back,donate,languages,customercare,facebook,insta,twiter,addtocart,image1,red,sky,yellow,plus,minus,option1,wishlist;
	JLabel logo,title,subtitle,line2,count,colorbg,name;
	JButton mblazer,mabaya;
	JRadioButton r1,r2,r3,r4;
	ButtonGroup bg1;
	
	private String product_dirndl="DIRNDL DRESS D6034";
	private String proPrice="150";
	private String quantity1="1";
	
	public Dirndl()
	{
		super("Dirndl Section");
		...
		image1 =new JButton(new ImageIcon("images/reddirndl.png"));
		...
		red.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==red)
				{
					image1.setIcon(new ImageIcon("images/reddirndl.png"));
		...
		sky.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==sky)
				{
					image1.setIcon(new ImageIcon("images/skydirndl.png"));
					image1.setBounds(50,90,300,470);
				}
			}
		});
		...
		yellow=new JButton(new ImageIcon("images/yellow.png"));
		yellow.setBounds(190,560,36,36);
		yellow.setBorder(null);
		yellow.setOpaque(false);
		yellow.setBackground(c1);
		yellow.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/yellowdirndl.png"));
		...
		name=new JLabel(product_dirndl);
		...
		JLabel name2=new JLabel("Aussie Fashion");
		...
		JLabel name3=new JLabel("yellow/sky/Red");
		...
		mblazerL.setBounds(990,310,250,30);
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase p=new Purchase(product_dirndl,proPrice,quantity1);
					Dirndl.this.setVisible(false);
					p.setVisible(true);
				}
			}
