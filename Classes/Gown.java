...
public class Gown extends JFrame implements MouseListener//, ActionListener
{
	...
	JButton back,donate,languages,customercare,facebook,insta,twiter,addtocart,image1,red,green,black,plus,minus,option1,wishlist;
	JLabel logo,title,subtitle,line2,count,colorbg,name;
	JButton maline,mdirndl;
	JRadioButton r1,r2,r3,r4;
	ButtonGroup bg1;
	
	private String product_gown="COMFORTABLE GOWN";
	...
	public Gown()
	{
		...
		title =new JLabel("G O W N");
		title.setBounds(75,5,200,50);
		//title.setBackground();
		...
		image1 =new JButton(new ImageIcon("images/blackgown.png"));
		image1.setBounds(10,90,300,470);
		...
		red.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==red)
				{
					image1.setIcon(new ImageIcon("images/redgown.png"));
		...
		green.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/greengown.png"));
		...
		black.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/blackgown.png"));
					image1.setBounds(10,90,300,470);
				}
			}
		});
		...
		*/
		name=new JLabel(product_gown);//+"\n"+"Sequin Jersey Maxi Dress"+" Black/Green/Red");
		...
		*/
		...
		JLabel name2=new JLabel("Three-Quarter Sleeves");//+"\n"+"Sequin Jersey Maxi Dress"+" Black/Green/Red");
		...
		JLabel name3=new JLabel("Black/Green/Red");//+"\n"+"Sequin Jersey Maxi Dress"+" ");
		...
		mdirndl.setBounds(915,150,250,160);
		...
		JLabel mdirndlL=new JLabel("D R I N D L E");
		mdirndlL.setBounds(990,310,200,30);
		mdirndlL.setForeground(new Color(60,80,110));
		mdirndlL.setFont(new Font("Garamond",Font.PLAIN,22));
		mdirndlL.setOpaque(false);
		panel.add(mdirndlL);
		
		maline=new JButton(new ImageIcon("images/maline.png"));
		maline.setBounds(915,370,250,160);
		maline.setBorder(null);
		maline.setOpaque(false);
		maline.setBorder(null);
		maline.addMouseListener(this);
		maline.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==maline)
				{
					Aline f=new Aline();
					Gown.this.setVisible(false);
					f.setVisible(true);
		...
		maline.setBackground(c1);
		panel.add(maline);
		
		JLabel malineL=new JLabel("A L I N E");
		malineL.setBounds(1000,540,200,30);
		malineL.setForeground(new Color(60,80,110));
		malineL.setFont(new Font("Garamond",Font.PLAIN,22));
		malineL.setOpaque(false);
		panel.add(malineL);
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase q=new Purchase(product_gown, proPrice , quantity1);
					Gown.this.setVisible(false);
					q.setVisible(true);
				}
			}
