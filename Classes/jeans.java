...
public class jeans extends JFrame implements MouseListener
{
	JLabel logo,donatepic,customercarepic,searchbar,line2,languagepic, title,subtitle,line1,jeansl,gownl,blackjeansL,ballgownl,sheathl,fitandflarel,alinel, name, name1;
	JPanel panel;
	...
	ButtonGroup bg1;
	//ImageIcon img;
	JButton back,donate,languages,customercare,jeans,gown,blackjeans,ballgown,sheath,fitandflare,aline,facebook,insta,twiter,image1,purchasep,p11,p22,p33;
	Border b1=BorderFactory.createLineBorder(new Color(120,120,120),3,true);
	JTextField searchT;
	JFrame frame;
	
	private String product_jeans="Stretchable Vintage Jeans Pant";
	private String proPrice="550";
	...
	public jeans()
	{
		...
		title = new JLabel("J E A N S");
		title.setBounds(90,05,300,50);
		...
		image1 =new JButton(new ImageIcon("image/jeans1.png"));
		...
		JLabel details1=new JLabel("Brand: UNICORN");
		details1.setBounds(125,530,300,25);
		...
		name=new JLabel("Stretchable Vintage Jeans Pant");
		...
		name1=new JLabel("Men’s Slim-Fit Casual Jeans");
		...
		JLabel extra1=new JLabel("4.4(89)");
		...
		p11=new JButton(new ImageIcon("image/jeans11.png"));
		...
		p11.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p11)
				{
					image1.setIcon(new ImageIcon("image/jeans1.png"));
					image1.setBounds(20,125,385,400);
				}
		...
		p22=new JButton(new ImageIcon("image/jeans22.png"));
		...
		p22.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p22)
				{
					image1.setIcon(new ImageIcon("image/jeans2.png"));
		...
		p33=new JButton(new ImageIcon("image/jeans33.png"));
		...
		p33.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p33)
				{
					image1.setIcon(new ImageIcon("image/jeans3.png"));
		...
		purchasep.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					purchasep q=new purchasep(product_jeans, proPrice , quantity1);
					frame.setVisible(false);
					q.setVisible(true);
				}
			}
