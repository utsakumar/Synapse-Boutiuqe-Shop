...
public class shirtc extends JFrame implements MouseListener
{
	JLabel logo,donatepic,customercarepic,searchbar,line2,languagepic, title,subtitle,line1,shirtcl,gownl,blackshirtcL,ballgownl,sheathl,fitandflarel,alinel, name, name1;
	JPanel panel;
	...
	ButtonGroup bg1;
	//ImageIcon img;
	JButton back,donate,languages,customercare,shirtc,gown,blackshirtc,ballgown,sheath,fitandflare,aline,facebook,insta,twiter,image1,purchasep,p11,p22,p33;
	Border b1=BorderFactory.createLineBorder(new Color(120,120,120),3,true);
	JTextField searchT;
	JFrame frame;
	
	private String product_shirtc="Taaga Man Casual Fusion Shirt";
	...
	public shirtc()
	{
		...
		image1 =new JButton(new ImageIcon("image/shirtc1.png"));
		...
		JLabel details1=new JLabel("Brand: HUGO BOSS");
		details1.setBounds(117,530,300,25);
		...
		name=new JLabel("Taaga Man Casual Fusion Shirt");
		...
		name1=new JLabel("Men Casual Shirt");
		...
		JLabel extra1=new JLabel("3.9(169)");
		...
		p11=new JButton(new ImageIcon("image/shirtc11.png"));
		...
		p11.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p11)
				{
					image1.setIcon(new ImageIcon("image/shirtc1.png"));
					image1.setBounds(20,125,385,400);
				}
		...
		p22=new JButton(new ImageIcon("image/shirtc22.png"));
		...
		p22.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p22)
				{
					image1.setIcon(new ImageIcon("image/shirtc2.png"));
					image1.setBounds(05,120,385,400);
				}
		...
		p33=new JButton(new ImageIcon("image/shirtc33.png"));
		...
		p33.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p33)
				{
					image1.setIcon(new ImageIcon("image/shirtc3.png"));
		...
		poloshirt.setBounds(935, 165, 190, 200);
		...
		poloshirtl.setBounds(970, 360, 200, 30);
		...
		jeans.setBounds(932, 390, 200, 197);
		...
		jeansL.setBounds(970, 585, 200, 30);
		...
		purchasep.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					purchasep q=new purchasep(product_shirtc, proPrice , quantity1);
					frame.setVisible(false);
					q.setVisible(true);
				}
			}
