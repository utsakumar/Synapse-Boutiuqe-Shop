...
public class dresspant extends JFrame implements MouseListener
{
	JLabel logo,donatepic,customercarepic,searchbar,line2,languagepic, title,subtitle,line1,dresspantl,gownl,blackdresspantL,ballgownl,sheathl,fitandflarel,alinel, name, name1;
	JPanel panel;
	...
	ButtonGroup bg1;
	//ImageIcon img;
	JButton back,donate,languages,customercare,dresspant,gown,blackdresspant,ballgown,sheath,fitandflare,aline,facebook,insta,twiter,image1,purchasep,p11,p22,p33;
	Border b1=BorderFactory.createLineBorder(new Color(120,120,120),3,true);
	JTextField searchT;
	JFrame frame;
	
	private String product_dresspant="Slim Fit Mens Cotton Dress Pant";
	private String proPrice="380";
	...
	public dresspant()
	{
		...
		title = new JLabel("DRESSPANT");
		title.setBounds(45,10,400,40);
		...
		image1 =new JButton(new ImageIcon("image/dresspant1.png"));
		...
		JLabel details1=new JLabel("Brand: DOCKERS");
		...
		name=new JLabel("Slim Fit Mens Cotton Dress Pant");
		...
		name1=new JLabel("Slim Fit Formal dresspant");
		...
		JLabel extra1=new JLabel("4.1(129)");
		...
		p11=new JButton(new ImageIcon("image/dresspant11.png"));
		...
		p11.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p11)
				{
					image1.setIcon(new ImageIcon("image/dresspant1.png"));
					image1.setBounds(20,125,385,400);
				}
		...
		p22=new JButton(new ImageIcon("image/dresspant22.png"));
		...
		p22.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p22)
				{
					image1.setIcon(new ImageIcon("image/dresspant2.png"));
		...
		p33=new JButton(new ImageIcon("image/dresspant33.png"));
		...
		p33.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p33)
				{
					image1.setIcon(new ImageIcon("image/dresspant3.png"));
		...
		JButton tie = new JButton(new ImageIcon("image/tie.png"));
		tie.setBounds(940, 390, 175, 200);
		...
		JLabel tiel = new JLabel("T I E");
		tiel.setBounds(1007, 585, 120, 30);
		...
		purchasep.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					purchasep q=new purchasep(product_dresspant, proPrice , quantity1);
					frame.setVisible(false);
					q.setVisible(true);
				}
			}
