...
public class Ballgown extends JFrame implements MouseListener
{
	...
	JButton back,donate,languages,customercare,facebook,insta,twiter,addtocart,image1,red,green,sky,plus,minus,option1,wishlist;
	JLabel logo,title,subtitle,line2,count,colorbg,name;
	JButton mgown,mkimono;
	JRadioButton r1,r2,r3,r4;
	ButtonGroup bg1;
	
	private String product_ballgown="LONG GLITTER BALLGOWN";
	private String proPrice="110";
	private String quantity1="1";
	
	public Ballgown()
	{
		super("Ballgown Brand");
		...
		back.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==back)
				{
					...
					Ballgown.this.setVisible(false);
					w.setVisible(true);
				}
			}
		});
		...
		title =new JLabel("B A L L G O W N");
		...
		image1 =new JButton(new ImageIcon("images/skyballgown.png"));
		...
		red.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==red)
				{
					image1.setIcon(new ImageIcon("images/redballgown.png"));
		...
		green.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/greenballgown.png"));
		...
		sky.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==sky)
				{
					image1.setIcon(new ImageIcon("images/skyballgown.png"));
					image1.setBounds(0,90,320,470);
				}
			}
		});
		...
		*/
		name=new JLabel(product_ballgown);
		...
		*/
		...
		JLabel name2=new JLabel("Formal Dress: 61134.");
		...
		JLabel name3=new JLabel("sky/Green/Red");
		...
		mkimono=new JButton(new ImageIcon("images/mkimono.png"));
		mkimono.setBounds(915,150,250,160);
		mkimono.setBorder(null);
		mkimono.setOpaque(false);
		mkimono.setBorder(null);
		mkimono.addMouseListener(this);
		mkimono.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==mkimono)
				{
					Kimono f=new Kimono();
					Ballgown.this.setVisible(false);
					f.setVisible(true);
		...
		mkimono.setBackground(c1);
		panel.add(mkimono);
		
		JLabel mkimonoL=new JLabel("K I M O N O");
		mkimonoL.setBounds(990,310,200,30);
		mkimonoL.setForeground(new Color(60,80,110));
		mkimonoL.setFont(new Font("Garamond",Font.PLAIN,22));
		mkimonoL.setOpaque(false);
		panel.add(mkimonoL);
		
		mgown=new JButton(new ImageIcon("images/mgown.png"));
		mgown.setBounds(915,370,250,160);
		mgown.setBorder(null);
		mgown.setOpaque(false);
		mgown.setBorder(null);
		mgown.addMouseListener(this);
		mgown.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==mgown)
				{
					Gown f=new Gown();
					Ballgown.this.setVisible(false);
					f.setVisible(true);
		...
		mgown.setBackground(c1);
		panel.add(mgown);
		
		JLabel mgownL=new JLabel("G O W N");
		mgownL.setBounds(1000,540,200,30);
		mgownL.setForeground(new Color(60,80,110));
		mgownL.setFont(new Font("Garamond",Font.PLAIN,22));
		mgownL.setOpaque(false);
		panel.add(mgownL);
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase q=new Purchase(product_ballgown, proPrice , quantity1);
					Ballgown.this.setVisible(false);
					q.setVisible(true);
				}
			}
	...
	public void mouseEntered(MouseEvent me)
	{
		...
		else if(me.getSource()==mgown)
		{
			mgown.setBorder(b1);
		}
		else if(me.getSource()==mkimono)
		{
			mkimono.setBorder(b1);
		}
