...
public class Blacktie extends JFrame implements MouseListener
{
	...
	JButton msaree,mblazer;
	JRadioButton r1,r2,r3,r4;
	ButtonGroup bg1;
	
	private String product_blacktie="PHASE EIGHT BLACKTIE";
	private String proPrice="180";
	private String quantity1="1";
	
	public Blacktie()
	{
		super("Black Tie Brand");
		...
		back.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==back)
				{
					...
					Blacktie.this.setVisible(false);
					w.setVisible(true);
				}
			}
		});
		...
		image1 =new JButton(new ImageIcon("images/blacktie1.png"));
		...
		red.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==red)
				{
					image1.setIcon(new ImageIcon("images/image3.png"));
		...
		black.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/blacktie1.png"));
					image1.setBounds(-35,90,300,470);
				}
			}
		});
		...
		*/
		name=new JLabel(product_blacktie);
		...
		*/
		...
		JLabel name2=new JLabel("Sequin Jersey Maxi Dress");//+"\n"+"Sequin Jersey Maxi Dress"+" Black/Green/Red");
		...
		msareeL.setBounds(990,310,200,30);
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase q=new Purchase(product_blacktie, proPrice , quantity1);
					Blacktie.this.setVisible(false);
					q.setVisible(true);
				}
			}
