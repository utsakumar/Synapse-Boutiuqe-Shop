...
public class Abaya extends JFrame implements MouseListener//, ActionListener
{
	...
	JButton back,donate,languages,customercare,facebook,insta,twiter,addtocart,image1,brown,sky,black,plus,minus,option1,wishlist;
	JLabel logo,title,subtitle,line2,count,colorbg,name;
	JButton mballgown,mdirndl;
	JRadioButton r1,r2,r3,r4;
	ButtonGroup bg1;
	
	private String product_abaya="CLASSICAL ABAYA";
	private String proPrice="375";
	...
	public Abaya()
	{
		...
		image1 =new JButton(new ImageIcon("images/skyabaya.png"));
		...
		brown=new JButton(new ImageIcon("images/brown.png"));
		brown.setBounds(110,560,36,36);
		brown.setBorder(null);
		brown.setOpaque(false);
		brown.setBackground(c1);
		brown.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/brownabaya.png"));
		...
		sky.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==sky)
				{
					image1.setIcon(new ImageIcon("images/skyabaya.png"));
		...
		black.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/blackabaya.png"));
					image1.setBounds(20,90,300,470);
				}
			}
		});
		...
		JLabel name2=new JLabel("Arabiyan Traditional");
		...
		JLabel name3=new JLabel("black/sky/brown");
		...
		mballgown.setBounds(915,150,250,160);
		...
		mballgownL.setBounds(980,310,250,30);
		...
		mdirndl=new JButton(new ImageIcon("images/mdirndl.png"));
		mdirndl.setBounds(915,370,250,160);
		mdirndl.setBorder(null);
		mdirndl.setOpaque(false);
		mdirndl.setBorder(null);
		mdirndl.addMouseListener(this);
		mdirndl.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==mdirndl)
				{
					Dirndl f=new Dirndl();
					Abaya.this.setVisible(false);
					f.setVisible(true);
		...
		mdirndl.setBackground(c1);
		panel.add(mdirndl);
		
		JLabel mdirndlL=new JLabel("D I R N D L");
		mdirndlL.setBounds(1000,540,200,30);
		mdirndlL.setForeground(new Color(60,80,110));
		mdirndlL.setFont(new Font("Garamond",Font.PLAIN,22));
		mdirndlL.setOpaque(false);
		panel.add(mdirndlL);
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase p=new Purchase(product_abaya,proPrice,quantity1);
					Abaya.this.setVisible(false);
					p.setVisible(true);
				}
			}
	...
	public void mouseEntered(MouseEvent me)
	{
		...
		else if(me.getSource()==mdirndl)
		{
			mdirndl.setBorder(b1);
		}
