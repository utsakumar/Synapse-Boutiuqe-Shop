...
public class Blazer extends JFrame implements MouseListener//, ActionListener
{
	...
	private String product_blazer="WOMEN BLAZER";
	private String proPrice="150";
	private String quantity1="1";
	
	public Blazer()
	{
		super("Blazer Section");
		...
		image1 =new JButton(new ImageIcon("images/blackblazer.png"));
		...
		red.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==red)
				{
					image1.setIcon(new ImageIcon("images/redblazer.png"));
					image1.setBounds(20,90,300,470);
				}
		...
		sky.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==sky)
				{
					image1.setIcon(new ImageIcon("images/skyblazer.png"));
		...
		black.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/blackblazer.png"));
					image1.setBounds(20,90,300,470);
				}
			}
		});
		...
		*/
		...
		JLabel name2=new JLabel("Women Office Coat");//+"\n"+"Sequin Jersey Maxi Dress"+" Black/Green/Red");
		...
		mfit=new JButton(new ImageIcon("images/mfitandflare.png"));
		mfit.setBounds(915,150,250,160);
		mfit.setBorder(null);
		mfit.setOpaque(false);
		mfit.setBorder(null);
		mfit.addMouseListener(this);
		mfit.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==mfit)
				{
		...
		mfit.setBackground(c1);
		panel.add(mfit);
		
		JLabel mfitl=new JLabel("Fit and Flare");
		mfitl.setBounds(1000,310,200,30);
		mfitl.setForeground(new Color(60,80,110));
		mfitl.setFont(new Font("Garamond",Font.PLAIN,22));
		mfitl.setOpaque(false);
		panel.add(mfitl);
		
		mabaya=new JButton(new ImageIcon("images/mskyabaya.png"));
		mabaya.setBounds(915,370,250,160);
		mabaya.setBorder(null);
		mabaya.setOpaque(false);
		mabaya.setBorder(null);
		mabaya.addMouseListener(this);
		mabaya.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==mabaya)
				{
					Abaya f=new Abaya();
					Blazer.this.setVisible(false);
					f.setVisible(true);
		...
		mabaya.setBackground(c1);
		panel.add(mabaya);
		
		JLabel mabayal=new JLabel("A B A Y A");
		mabayal.setBounds(1000,540,200,30);
		mabayal.setForeground(new Color(60,80,110));
		mabayal.setFont(new Font("Garamond",Font.PLAIN,22));
		mabayal.setOpaque(false);
		panel.add(mabayal);
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase q=new Purchase(product_blazer, proPrice , quantity1);
					Blazer.this.setVisible(false);
					q.setVisible(true);
					//System.out.println(product_kimono+"    "+proPrice+"    "+quantity1);
				}
			}
		});
		panel.add(addtocart);
		
		//ine2.setBounds(900,90,3,496);
	...
	public void mouseEntered(MouseEvent me)
	{
		...
		else if(me.getSource()==mfit)
		{
			mfit.setBorder(b1);
		}
		else if(me.getSource()==mabaya)
		{
			mabaya.setBorder(b1);
		}
