...
public class Sheathdress extends JFrame implements MouseListener
{
	...
	JButton mkaftan,mballgown;
	JRadioButton r1,r2,r3,r4;
	ButtonGroup bg1;
	
	private String product_sheathdress="WOMEN'S SHEATH DRESS";
	private String proPrice="145";
	private String quantity1="1";
	
	public Sheathdress()
	{
		super("Sheathdress Brand");
		...
		back.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==back)
				{
					...
					Sheathdress.this.setVisible(false);
					w.setVisible(true);
				}
			}
		});
		...
		title =new JLabel("SHEATH DRESS");
		title.setBounds(50,5,320,50);
		//title.setBackground();
		...
		image1 =new JButton(new ImageIcon("images/blacksheathdress.png"));
		image1.setBounds(0,90,320,470);
		...
		red.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==red)
				{
					image1.setIcon(new ImageIcon("images/redsheathdress.png"));
		...
		sky.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==sky)
				{
					image1.setIcon(new ImageIcon("images/skysheathdressl.png"));
					image1.setBounds(30,90,300,470);
				}
			}
		});
		panel.add(sky);
		...
		black.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/blacksheathdress.png"));
					image1.setBounds(0,90,320,470);
				}
			}
		});
		...
		*/
		name=new JLabel(product_sheathdress);
		...
		*/
		...
		JLabel name2=new JLabel("Floral Embroidered Sheath Gown");
		name2.setBounds(460,140,420,40);
		name2.setForeground(new Color(150, 220, 220));
		name2.setOpaque(false);
		name2.setFont(new Font("Garamond",Font.BOLD,28));
		name2.setBorder(null);
		panel.add(name2);
		
		JLabel name3=new JLabel("sky/black/Red");
		...
		mkaftan=new JButton(new ImageIcon("images/mkaftan.png"));
		mkaftan.setBounds(915,150,250,160);
		mkaftan.setBorder(null);
		mkaftan.setOpaque(false);
		mkaftan.setBorder(null);
		mkaftan.addMouseListener(this);
		mkaftan.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==mkaftan)
				{
					Kaftan f=new Kaftan();
					Sheathdress.this.setVisible(false);
					f.setVisible(true);
		...
		mkaftan.setBackground(c1);
		panel.add(mkaftan);
		
		JLabel mkaftanL=new JLabel("K A F T A N");
		mkaftanL.setBounds(990,310,200,30);
		mkaftanL.setForeground(new Color(60,80,110));
		mkaftanL.setFont(new Font("Garamond",Font.PLAIN,22));
		mkaftanL.setOpaque(false);
		panel.add(mkaftanL);
		
		mballgown=new JButton(new ImageIcon("images/mballgown.png"));
		mballgown.setBounds(915,370,250,160);
		mballgown.setBorder(null);
		mballgown.setOpaque(false);
		mballgown.setBorder(null);
		mballgown.addMouseListener(this);
		mballgown.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==mballgown)
				{
					Ballgown f=new Ballgown();
					Sheathdress.this.setVisible(false);
					f.setVisible(true);
				}
			}
		});
		mballgown.setBackground(c1);
		panel.add(mballgown);
		
		JLabel mballgownL=new JLabel("B A L L G O W N");
		mballgownL.setBounds(970,540,200,30);
		mballgownL.setForeground(new Color(60,80,110));
		mballgownL.setFont(new Font("Garamond",Font.PLAIN,22));
		mballgownL.setOpaque(false);
		panel.add(mballgownL);
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase q=new Purchase(product_sheathdress, proPrice , quantity1);
					Sheathdress.this.setVisible(false);
					q.setVisible(true);
				}
			}
	...
	public void mouseEntered(MouseEvent me)
	{
		...
		else if(me.getSource()==mkaftan)
		{
			mkaftan.setBorder(b1);
		}
		else if(me.getSource()==mballgown)
		{
			mballgown.setBorder(b1);
		}
		...
		else if(me.getSource()==image1)
		{
			image1.setIcon(new ImageIcon("images/blacktie2.png"));
			image1.setBounds(0,90,300,470);
		}*/
	...
	{
		new Sheathdress ().setVisible(true);
	}*/
