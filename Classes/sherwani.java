...
public class sherwani extends JFrame implements MouseListener
{
	JLabel logo,donatepic,customercarepic,searchbar,line2,languagepic, title,subtitle,line1,sherwanil,gownl,blacksherwaniL,ballgownl,sheathl,fitandflarel,alinel, name, name1;
	JPanel panel;
	...
	ButtonGroup bg1; 
	//ImageIcon img;
	JButton back,donate,languages,customercare,sherwani,gown,blacksherwani,ballgown,sheath,fitandflare,aline,facebook,insta,twiter,image1,purchasep,p11,p22,p33;
	Border b1=BorderFactory.createLineBorder(new Color(120,120,120),3,true);
	JTextField searchT;
	JFrame frame;
	
	private String product_sherwani="Woven Art Silk Jacquard Sherwani";
	...
	public sherwani()
	{
		...
		image1 =new JButton(new ImageIcon("image/sherwani1.png"));
		...
		JLabel details1=new JLabel("Brand: SABYASACHI");
		...
		name=new JLabel("Woven Art Silk Jacquard Sherwani");
		...
		name1=new JLabel("Men Formal sherwani");
		...
		JLabel extra1=new JLabel("4.0(769)");
		...
		p11=new JButton(new ImageIcon("image/sherwani11.png"));
		...
		p11.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p11)
				{
					image1.setIcon(new ImageIcon("image/sherwani1.png"));
					image1.setBounds(20,125,385,400);
				}
		...
		p22=new JButton(new ImageIcon("image/sherwani22.png"));
		...
		p22.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p22)
				{
					image1.setIcon(new ImageIcon("image/sherwani2.png"));
		...
		p33=new JButton(new ImageIcon("image/sherwani33.png"));
		...
		p33.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p33)
				{
					image1.setIcon(new ImageIcon("image/sherwani3.png"));
		...
		punjabi.setBounds(935, 160, 190, 200);
		...
		punjabiL.setBounds(985, 355, 150, 30);
		punjabiL.setForeground(new Color(60, 80, 110));
		punjabiL.setFont(new Font("Garamond", Font.PLAIN, 20));
		punjabiL.setOpaque(false);
		frame.add(punjabiL);
		
		JButton shirt = new JButton(new ImageIcon("image/shirt.png"));
		shirt.setBounds(935, 390, 200, 200);
		...
		JLabel shirtl = new JLabel("D R E S S  S H I R T");
		shirtl.setBounds(950, 585, 250, 30);
		...
		purchasep.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					purchasep q=new purchasep(product_sherwani, proPrice , quantity1);
					frame.setVisible(false);
					q.setVisible(true);
				}
			}
