...
public class punjabi extends JFrame implements MouseListener
{
	JLabel logo,donatepic,customercarepic,searchbar,line2,languagepic, title,subtitle,line1,punjabil,gownl,blackpunjabiL,ballgownl,sheathl,fitandflarel,alinel, name, name1;
	JPanel panel;
	...
	ButtonGroup bg1;
	ImageIcon img,icon;
	JButton back,donate,languages,customercare,punjabi,gown,blackpunjabi,ballgown,sheath,fitandflare,aline,facebook,insta,twiter,image1,purchasep,p11,p22,p33;
	Border b1=BorderFactory.createLineBorder(new Color(120,120,120),3,true);
	JTextField searchT;
	JFrame frame;
	
	private String product_punjabi="EXCLUSIVE SLIM FITTED COTTON PANJABI";
	private String proPrice="350";
	...
	public punjabi()
	{
		...
		image1 =new JButton(new ImageIcon("image/punjabi1.png"));
		...
		JLabel details1=new JLabel("Brand: ILLIYEEN");
		...
		name=new JLabel("EXCLUSIVE SLIM FITTED COTTON PANJABI");
		...
		name1=new JLabel("Men Formal punjabi");
		...
		JLabel extra1=new JLabel("4.1(149)");
		...
		p11=new JButton(new ImageIcon("image/punjabi11.png"));
		...
		p11.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p11)
				{
					image1.setIcon(new ImageIcon("image/punjabi1.png"));
					image1.setBounds(10,125,385,400);
				}
		...
		p22=new JButton(new ImageIcon("image/punjabi22.png"));
		...
		p22.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p22)
				{
					image1.setIcon(new ImageIcon("image/punjabi2.png"));
		...
		p33=new JButton(new ImageIcon("image/punjabi33.png"));
		...
		p33.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p33)
				{
					image1.setIcon(new ImageIcon("image/punjabi3.png"));
					image1.setBounds(10,120,385,400);
				}
		...
		JButton sherwani = new JButton(new ImageIcon("image/sherwani.png"));
		sherwani.setBounds(935, 160, 200, 210);
		...
		JLabel sherwanil = new JLabel("S H E R W A N I");
		sherwanil.setBounds(980, 365, 150, 30);
		...
		dresspant.setBounds(945, 393, 175, 200);
		...
		dresspant1.setBounds(965, 587, 200, 30);
		...
		purchasep.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					purchasep q=new purchasep(product_punjabi, proPrice , quantity1);
					frame.setVisible(false);
					q.setVisible(true);
				}
			}
