...
public class Kaftan extends JFrame implements MouseListener//, ActionListener
{
	...
	JButton back,donate,languages,customercare,facebook,insta,twiter,addtocart,image1,green,white,red,plus,minus,option1,wishlist;
	JLabel logo,title,subtitle,line2,count,colorbg,name;
	JButton mhanbok,mabaya;
	JRadioButton r1,r2,r3,r4;
	ButtonGroup bg1;
	
	private String product_kaftan="BOHEMIAN KAFTAN";
	private String proPrice="330";
	private String quantity1="1";
	public Kaftan()
	{
		super("Kaftan Section");
		...
		title =new JLabel("K A F T A N");
		title.setBounds(80,5,250,50);
		title.setBackground(c1);
		title.setForeground(new Color(60,80,110));
		title.setFont(new Font("Garamond",Font.BOLD,38));
		...
		image1 =new JButton(new ImageIcon("images/greenkaftan.png"));
		image1.setBounds(40,90,300,470);
		...
		green.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/greenkaftan.png"));
					image1.setBounds(40,90,300,470);
				}
		...
		white=new JButton(new ImageIcon("images/white.png"));
		white.setBounds(150,560,36,36);
		white.setBorder(null);
		white.setOpaque(false);
		white.setBackground(c1);
		white.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/whitekaftan.png"));
		...
		red.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==red)
				{
					image1.setIcon(new ImageIcon("images/redkaftan.png"));
		...
		name=new JLabel(product_kaftan);
		...
		JLabel name2=new JLabel("İstanbul Traditional");
		...
		JLabel name3=new JLabel("white/red/green");
		...
		mhanbok.setBounds(915,150,250,160);
		...
		mhanbokL.setBounds(990,310,200,30);
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase p=new Purchase(product_kaftan,proPrice,quantity1);
					Kaftan.this.setVisible(false);
					p.setVisible(true);
				}
			}
