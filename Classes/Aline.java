...
public class Aline extends JFrame implements MouseListener
{
	...
	JButton back,donate,languages,customercare,facebook,insta,twiter,addtocart,image1,sky,green,black,plus,minus,option1,wishlist;
	JLabel logo,title,subtitle,line2,count,colorbg,name;
	JButton mdirndl,mblazer;
	JRadioButton r1,r2,r3,r4;
	ButtonGroup bg1;
	
	private String product_aline="SYNAPSE A-LINE 4701";
	...
	public Aline()
	{
		...
		image1 =new JButton(new ImageIcon("images/blackaline.png"));
		...
		sky.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==sky)
				{
					image1.setIcon(new ImageIcon("images/skyaline.png"));
		...
		green.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/greenaline.png"));
		...
		black.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/blackaline.png"));
					image1.setBounds(0,90,320,470);
				}
			}
		});
		...
		*/
		...
		JLabel name2=new JLabel("Broken Angel Fashion");
		...
		JLabel name3=new JLabel("black/Green/sky");
		...
		mblazer.setBounds(915,370,250,160);
		...
		mblazerL.setBounds(1000,540,200,30);
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase q=new Purchase(product_aline, proPrice , quantity1);
					Aline.this.setVisible(false);
					q.setVisible(true);
				}
			}
