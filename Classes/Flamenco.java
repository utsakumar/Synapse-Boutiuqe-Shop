...
public class Flamenco extends JFrame implements MouseListener//, ActionListener
{
	...
	JButton back,donate,languages,customercare,facebook,insta,twiter,addtocart,image1,green,sky,red,plus,minus,option1,wishlist;
	JLabel logo,title,subtitle,line2,count,colorbg,name;
	JButton msaree,mfitandflare;
	JRadioButton r1,r2,r3,r4;
	ButtonGroup bg1;
	
	private String product_flamenco="FLAMENCA ESTEPONA DRESS";
	...
	public Flamenco()
	{
		...
		back.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==back)
				{
					...
					Flamenco.this.setVisible(false);
					w.setVisible(true);
				}
			}
		});
		...
		title =new JLabel("F L A M E N C O");
		title.setBounds(40,5,300,50);
		...
		image1 =new JButton(new ImageIcon("images/redflamenco.png"));
		image1.setBounds(60,90,300,470);
		...
		green.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/greenflamenco.png"));
		...
		sky.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==sky)
				{
					image1.setIcon(new ImageIcon("images/skyflamenco.png"));
		...
		red.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==red)
				{
					image1.setIcon(new ImageIcon("images/redflamenco.png"));
					image1.setBounds(60,90,300,470);
				}
			}
		});
		...
		name=new JLabel(product_flamenco);
		name.setBounds(460,100,420,40);
		name.setForeground(c3);
		name.setOpaque(false);
		name.setFont(new Font("Garamond",Font.BOLD,27));
		name.setBorder(null);
		panel.add(name);
		
		JLabel name2=new JLabel("Española Traditional");
		name2.setBounds(460,140,420,40);
		name2.setForeground(new Color(60,80,110));
		name2.setOpaque(false);
		name2.setFont(new Font("Garamond",Font.BOLD,24));
		...
		name3.setFont(new Font("Garamond",Font.BOLD,22));
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase p=new Purchase(product_flamenco,proPrice,quantity1);
					Flamenco.this.setVisible(false);
					p.setVisible(true);
				}
			}
