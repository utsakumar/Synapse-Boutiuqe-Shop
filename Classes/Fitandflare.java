...
public class Fitandflare extends JFrame implements MouseListener
{
	...
	JButton mhanbok,maline;
	JRadioButton r1,r2,r3,r4;
	ButtonGroup bg1;
	
	private String product_fitandflare="SYNAPSE FITANDFLARE";
	private String proPrice="210";
	private String quantity1="1";
	
	public Fitandflare()
	{
		super("FitandFlare Brand");
		...
		back.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==back)
				{
					...
					Fitandflare.this.setVisible(false);
					w.setVisible(true);
				}
			}
		});
		...
		image1 =new JButton(new ImageIcon("images/blackfitandflare.png"));
		...
		red.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==red)
				{
					image1.setIcon(new ImageIcon("images/redfitandflare.png"));
		...
		green.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/greenfitandflare.png"));
		...
		black.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/blackfitandflare.png"));
					image1.setBounds(0,90,320,470);
				}
			}
		});
		...
		*/
		name=new JLabel(product_fitandflare);
		...
		*/
		...
		JLabel name2=new JLabel("Synapse 07012 ");
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase q=new Purchase(product_fitandflare, proPrice , quantity1);
					Fitandflare.this.setVisible(false);
					q.setVisible(true);
				}
			}
	...
	public void mouseEntered(MouseEvent me)
	{
		...
		{
			addtocart.setBackground(new Color(255, 128, 171));
			addtocart.setForeground(Color.BLACK);
		}
	...
	{
		new Fitandflare ().setVisible(true);
	}*/
