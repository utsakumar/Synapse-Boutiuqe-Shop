...
public class blazerb extends JFrame implements MouseListener
{
	JLabel logo,donatepic,customercarepic,searchbar,line2,languagepic, title,subtitle,line1,blazerbl,gownl,blacktieL,ballgownl,sheathl,fitandflarel,alinel, name, name1;
	JPanel panel;
	...
	ButtonGroup bg1;
	//ImageIcon img;
	JButton back,donate,languages,customercare,blazerb,gown,blacktie,ballgown,sheath,fitandflare,aline,facebook,insta,twiter,image1,purchasep,p11,p22,p33;
	Border b1=BorderFactory.createLineBorder(new Color(120,120,120),3,true);
	JTextField searchT;
	JFrame frame;
	
	private String product_blazerb="Men Solid Single Breasted Blazer";
	...
	public blazerb()
	{
		...
		image1 =new JButton(new ImageIcon("image/blazer1.png"));
		image1.setBounds(45,115,385,400);
		image1.setBackground(c1);
		image1.setOpaque(true);
		image1.setBorder(null);
		frame.add(image1);
		
		JLabel details1=new JLabel("Brand: IQON");
		...
		name=new JLabel("Men Solid Single Breasted Blazer");
		...
		name1=new JLabel("Casual, Formal, Festive & Wedding blazer");
		...
		JLabel extra1=new JLabel("4.1(98)");
		...
		p11=new JButton(new ImageIcon("image/blazer11.png"));
		...
		p11.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p11)
				{
					image1.setIcon(new ImageIcon("image/blazer1.png"));
					image1.setBounds(45,115,385,400);
				}
		...
		p22=new JButton(new ImageIcon("image/blazer22.png"));
		...
		p22.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p22)
				{
					image1.setIcon(new ImageIcon("image/blazer2.png"));
					image1.setBounds(45,115,385,400);
				}
		...
		p33=new JButton(new ImageIcon("image/blazer33.png"));
		...
		p33.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p33)
				{
					image1.setIcon(new ImageIcon("image/blazer3.png"));
					image1.setBounds(45,115,385,400);
				}
		...
		punjabi.setBounds(935, 390, 180, 200);
		...
		purchasep.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					purchasep q=new purchasep(product_blazerb, proPrice , quantity1);
					frame.setVisible(false);
					q.setVisible(true);
				}
			}
