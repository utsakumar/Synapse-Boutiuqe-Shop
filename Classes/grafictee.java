...
public class grafictee extends JFrame implements MouseListener
{
	JLabel logo,donatepic,customercarepic,searchbar,line2,languagepic, title,subtitle,line1,graficteel,gownl,blackgraficteeL,ballgownl,sheathl,fitandflarel,alinel, name, name1;
	JPanel panel;
	...
	ButtonGroup bg1;
	//ImageIcon img;
	JButton back,donate,languages,customercare,grafictee,gown,blackgrafictee,ballgown,sheath,fitandflare,aline,facebook,insta,twiter,image1,purchasep,p11,p22,p33;
	Border b1=BorderFactory.createLineBorder(new Color(120,120,120),3,true);
	JTextField searchT;
	JFrame frame;
	
	private String product_grafictee="Wyoming Short Graphic T-Shirt";
	private String proPrice="180";
	...
	public grafictee()
	{
		...
		title = new JLabel("GRAFIC TEE");
		title.setBounds(60,05,400,40);
		title.setFont(new Font("Garamond",Font.PLAIN+Font.BOLD,40));
		...
		image1 =new JButton(new ImageIcon("image/grafictee1.png"));
		...
		JLabel details1=new JLabel("Brand: PALM ANGELS");
		details1.setBounds(100,530,300,25);
		...
		name=new JLabel("Wyoming Short Graphic T-Shirt");
		...
		name1=new JLabel("Men Casual Sleeve Grafic T-Shirt");
		name1.setBounds(450,165,500,25);
		//name.setForeground(c2);
		...
		JLabel extra1=new JLabel("4.4(300)");
		...
		p11=new JButton(new ImageIcon("image/grafictee11.png"));
		...
		p11.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p11)
				{
					image1.setIcon(new ImageIcon("image/grafictee1.png"));
					image1.setBounds(20,125,385,400);
				}
		...
		p22=new JButton(new ImageIcon("image/grafictee22.png"));
		...
		p22.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p22)
				{
					image1.setIcon(new ImageIcon("image/grafictee2.png"));
		...
		p33=new JButton(new ImageIcon("image/grafictee33.png"));
		...
		p33.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==p33)
				{
					image1.setIcon(new ImageIcon("image/grafictee3.png"));
		...
		JButton shorts = new JButton(new ImageIcon("image/shorts.png"));
		shorts.setBounds(935, 170, 200, 200);
		...
		JLabel shortsl = new JLabel("C U R G O  S H O R T S");
		shortsl.setBounds(940, 365, 250, 30);
		shortsl.setForeground(new Color(60, 80, 110));
		shortsl.setFont(new Font("Garamond", Font.PLAIN, 20));
		shortsl.setOpaque(false);
		frame.add(shortsl);
		
		JButton vnecksweater = new JButton(new ImageIcon("image/vnecksweater.png"));
		vnecksweater.setBounds(935, 390, 200, 200);
		...
		JLabel vnecksweater1 = new JLabel("V - N E C K  S W E A T E R");
		vnecksweater1.setBounds(940, 585, 250, 30);
		...
		purchasep.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					purchasep q=new purchasep(product_grafictee, proPrice , quantity1);
					frame.setVisible(false);
					q.setVisible(true);
				}
			}
