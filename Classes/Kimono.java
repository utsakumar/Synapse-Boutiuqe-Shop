...
public class Kimono extends JFrame implements MouseListener//, ActionListener
{
	...
	JButton mfitandflare,mkaftan;
	JRadioButton r1,r2,r3,r4;
	ButtonGroup bg1;
	private String product_kimono="KIMONO ROBE";
	private String proPrice="225";
	private String quantity1="1";
	
	public Kimono()
	{
		super("Kimono Section");
		...
		image1 =new JButton(new ImageIcon("images/blackkimono.png"));
		...
		red.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==red)
				{
					image1.setIcon(new ImageIcon("images/redKimono.png"));
		...
		sky.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==sky)
				{
					image1.setIcon(new ImageIcon("images/skykimono.png"));
		...
		black.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					image1.setIcon(new ImageIcon("images/blackKimono.png"));
					image1.setBounds(20,90,300,470);
				}
			}
		});
		...
		name=new JLabel(product_kimono);
		...
		JLabel name2=new JLabel("Japanese Fashion");
		...
		wishlist.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(ae.getSource()==wishlist)
				{
					ImageIcon img=new ImageIcon("wishlist.png");
					//JOptionPane.showMessageDialoge(null,"Added to Your wishlist");
					JOptionPane.showMessageDialog(null,"Added Successfully","Message",JOptionPane.PLAIN_MESSAGE,img);//1
				}
			}
		});
		panel.add(wishlist);
		...
		mfitandflare.setBounds(915,150,250,160);
		...
		mfitandflareL.setBounds(940,310,250,30);
		...
		mkaftan.setBounds(915,370,250,160);
		...
		mkaftanL.setBounds(980,540,200,30);
		...
		addtocart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				{
					Purchase q=new Purchase(product_kimono , proPrice , quantity1);
					Kimono.this.setVisible(false);
					q.setVisible(true);
