...
public class Signup extends JFrame {
    ...
    public Signup(String s5,String s6,String s4,String s7,String s9){
        super("Sign Up");
        frame = new JFrame();
        ...
        jbutton2.setIcon(new ImageIcon("images/Signup.png")); //Login Button
        jbutton2.setBounds(520,500,160,100);
        jbutton2.setBorder(null);
        jbutton2.setCursor(new Cursor(Cursor.HAND_CURSOR));
        jbutton2.setContentAreaFilled(false);
        frame.add(jbutton2);

        label22 = new JLabel("I have already an Account!");
        label22.setBounds(465,590,220,40);
        label22.setForeground(Color.black);
        label22.setFont(new Font("Segoe UI", Font.PLAIN, 18));
        frame.add(label22);

        jbutton3 = new JButton("Login"); //Signup button
        jbutton3.setBounds(635,590,150,40);
            ...
            public void actionPerformed(ActionEvent ae){
                ...
                ((security.getSelectedIndex()) == 0)){
                    ...
                    try{
                        ...
                        JOptionPane.showConfirmDialog(null,"Wrong Captcha Input");
                        ef.printStackTrace();
                    }
                    ...
                    if(result !=(a+b)){
                        ...
                        JOptionPane.showConfirmDialog(null,"Account Created","Message",-1);
                        new Login("s1","s2");
                        frame.setVisible(false);
                    }
                }
